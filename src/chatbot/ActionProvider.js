...
const ActionProvider = ({ createChatBotMessage, setState, children }) => {
  ...
  const handleDescDataset = () => {
    const botMessage = createChatBotMessage('Набор данных состоит из 233 деталей, принадлежащих к 5 классам: болты, гайки, шайбы, подшипники и сальники. Каждой детали соответствует стандарт, размер и некоторое количество изображений на чертеже в разных проекциях и разворотах.');
